...
class Product extends CommerceProduct
{
    ...
    {
        // $fields = parent::ownerBaseFieldDefinitions($entity_type);
        // Define the owner field here.
        return [];
        // return $fields;
    }
    ...
    public static function baseFieldDefinitions(EntityTypeInterface $entity_type)
    {
        ...
        // var_dump(BaseFieldDefinition::create());
        // die;
        ...
        $fields['published'] = BaseFieldDefinition::create('boolean')
            ...
            // ->setDescription(t('Whether the product is published or not.'))
            ->setDefaultValue(TRUE) // Set to TRUE by default
            ->setDisplayOptions('form', [
        ...
        // Define the published field.
        $fields['status']->setDescription(t('Whether the product is published.')); // Make sure 'status' field exists in commerce_product base fields.
